    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1373&q=80" 
          alt="key"
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          ...
          <input className="w-full px-4 py-2 text-xl text-gray-700 
            ...
            {showPassword ? 
            <AiFillEyeInvisible  onClick={()=>setShowPassword((prevState) =>!prevState)} className="absolute right-3 top-3 text-xl cursor-pointer" /> : 
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              ...
              <p >
                <Link className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out ml-1" to="/forget-password">Forget password</Link>
              </p>
            </div>
